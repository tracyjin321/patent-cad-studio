...
ASSEMBLY_TEMPLATES = (
    ...
    AssemblyTemplate(
        ...
        components=(
            ...
            ("circlip-external-gbt894-1-d20", "输入端 20 mm 轴用弹性挡圈"),
            ("bearing-6004-2z-gbt276", "输入端 6004-2Z 深沟球轴承"),
            ("bearing-6004-2z-gbt276", "齿轮侧 6004-2Z 深沟球轴承"),
            ("circlip-internal-gbt893-1-d42", "轴承组 42 mm 孔用弹性挡圈"),
            ...
            ("circlip-external-gbt894-1-d20", "齿轮端 20 mm 轴用弹性挡圈"),
        ),
        relations=(
            (0, 1, "输入端轴用挡圈在轴槽内定位"),
            (0, 2, "第一轴承与阶梯轴同轴配合"),
